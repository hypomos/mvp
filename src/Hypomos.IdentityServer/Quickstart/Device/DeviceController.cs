...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class DeviceController : Controller
    {
        ...
        public DeviceController(IDeviceFlowInteractionService interaction, IEventService eventService, IOptions<IdentityServerOptions> options, ILogger<DeviceController> logger)
        {
